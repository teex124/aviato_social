...
context = {'all_posts': [{'Autor': 'AVIATO_GROUP','Date': '29 июля 2024',
    'Text': '''Наш сервис совершенствуется с каждым днём! ✈️ Мы рады сообщить, что
    внедрили новую систему онлайн-регистрации, которая экономит ваше время в
    аэропорту. Теперь вы можете выбрать место и получить посадочный талон
    прямо из дома или офиса. Мы убеждены, что удобство клиента - это не
    роскошь, а необходимость. Попробуйте новую функцию и поделитесь
    впечатлениями! #ИнновацииВАвиации #AVIATO2024 #УдобствоПревышеВсего'''},
                             {
                                'Autor': 'MainCraft_Rok',
                                'Date': '3 декаря 2024',
